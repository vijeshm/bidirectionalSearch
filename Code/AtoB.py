...
def simple_query(GLearnt, trials):
	...
	for i in range(trials):
		...
		if A != B :
			...
			#TwoWayAdamicFullPaths.append(float(len(PlainAdamicFullPath))/len(ShortestPath))
			#PlainAdamicFullPaths.append(float(len(TwoWayAdamicFullPath))/len(ShortestPath))
			
			TwoWayAdamicFullPaths.append(float(len(TwoWayAdamicFullPath)))
			PlainAdamicFullPaths.append(float(len(PlainAdamicFullPath)))
	...
	print "\nAvg of TwoWayAdamicFullPaths :" , numpy.average(TwoWayAdamicFullPaths)
